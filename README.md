...
with a role-based admin area just for you — a Claude admin assistant that drafts content and helps
with fixes (you review and apply), plus an editable welcome note. There is **no** hardcoded password
or backdoor; admin is a flag on your own account. Setup steps: see `SUPABASE_SETUP.md`.
