...
/* ---------- chat ---------- */
function Chat({ char, profile, answers, history, setHistory, plan, progress, saveProgress, persona, memories, onConversation, voiceOn, setVoiceOn, onBack, onOpenTool, embedded, bargeIn, responseSpeed }) {
  ...
  return (
    <div style={embedded ? {} : { minHeight: "100vh", display: "flex", flexDirection: "column" }}>
      ...
      <p style={{ fontSize: 10.5, color: T.sub, textAlign: "center", marginTop: 4 }}>
        ⚡ Fast Reply sends this message and asks for a quick, to-the-point answer — just this once. Photos only — our guides cannot view video files.
      </p>
      {speaking && (
