      ...
      <main style={{ marginTop: 8, paddingBottom: 30 }}>
        <section style={{ background: "linear-gradient(135deg, #ffd8d3 0%, #ffeae5 45%, #fffaf5 100%)", border: "1px solid rgba(190,25,21,0.22)", borderRadius: 26, padding: 0, minHeight: 218, boxShadow: "0 16px 34px rgba(172,39,39,0.14)", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ minHeight: 218, display: "flex", alignItems: "stretch", position: "relative" }}>
            <div style={{ width: "42%", minWidth: 130, display: "flex", alignItems: "flex-end", justifyContent: "center", padding: "10px 7px 0", background: "linear-gradient(180deg, rgba(255,255,255,0.64), rgba(255,244,238,0.42))", borderRadius: "24px 0 0 24px", boxShadow: "inset -1px 0 rgba(255,255,255,0.46)" }}><img src="/partners/chaptly-character-transparent.png" alt="Chaptly character" style={{ width: "100%", maxWidth: 178, height: 213, objectFit: "contain", objectPosition: "center bottom", filter: "drop-shadow(0 11px 10px rgba(123,0,0,0.24))" }} /></div>
        ...
        <section style={{ background: "linear-gradient(135deg, #fff8f5 0%, #fffdfb 100%)", border: "1px solid rgba(190,25,21,0.14)", borderRadius: 22, padding: "20px 18px", marginTop: 14, boxShadow: T.soft }}>
          <h2 style={{ margin: 0, color: "#8f120f", fontSize: 22 }}>How Chaptly can support you</h2>
