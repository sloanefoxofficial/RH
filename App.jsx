...
- Getting around: the home screen has a welcome, a card to chat with you (Rex), and cards for the 8-Week Plan & Guides tab (their plan plus Carlos and Juan), the other guides, the toolkit, the merch store, Message Juan, and notifications. Each card opens its own screen.
    ...
    <header style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 10, padding: "18px 2px 8px" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 10, flexShrink: 0 }}>
        ...
        <div style={{ lineHeight: 1.15 }}>
          ...
          <div style={{ fontSize: 11, color: T.sub, marginTop: 2 }}>You never have to<br />walk it alone</div>
        </div>
      </div>
      {right && (
...
const REX_INTRO_LINES = [
  ...
  "If you do go ahead with one, you'll find Carlos inside your 8-Week Plan & Guides tab, right there with your plan whenever you want to talk.",
    ...
    <>
      ...
      <div style={{ paddingTop: 8, textAlign: "center" }}>
        ...
        <p style={{ fontSize: 12, color: T.sub, marginTop: 14, lineHeight: 1.5 }}>
          You can start a plan any time from the 8-Week Plan & Guides page.
        </p>
      </div>
    </>
  );
...
function ProgramPage({ profile, plan, progress, saveProgress, journalCount, onOpenChat, onOpenJournal, onStartPlan, onBack }) {
  ...
  return (
    <>
      <Brand right={<BackBtn onBack={onBack} />} />
      <SectionTitle>8-Week Plan &amp; Guides</SectionTitle>
...
function Hub({ profile, plan, progress, saveProgress, journalCount, voiceOn, setVoiceOn, onOpenChat, onOpenProgram, onOpenGuides, onOpenMerch, onOpenToolkit, onOpenNotifications, onOpenCoordinator, onOpenSettings, onReset, isAdmin, authEnabled, onOpenAdmin, onOpenProfile, onSignOut, session, rexHistory, onSaveRexChat, memories, onConversation, answers, bargeIn, rexPersona }) {
  ...
  return (
    <>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
        {card(onOpenProgram, "#e7eefb", "#3f6faf", CalendarCheck, "8-Week Plan & Guides", "Your plan, progress, journal, Carlos & Juan")}
