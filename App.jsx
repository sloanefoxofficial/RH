...
import {
  ...
  Shield, Eye, EyeOff, User, Megaphone, Youtube, ExternalLink, Radio, Paperclip, MessageCircle, Share2, Flame, HelpCircle, Plus,
} from "lucide-react";
...
export default function App() {
  ...
  return (
    <div style={{ minHeight: "100vh", color: T.ink,
      ...
      <StyleTag />
      <div style={{ maxWidth: 460, margin: "0 auto", padding: "0 16px 132px", position: "relative", zIndex: 1 }}>
        {authEnabled && !authChecked ? (
          ...
          <MemoryManager memories={memories} memoryOn={memoryOn}
            onSave={(list, on) => saveMemories(list, on)} onBack={() => go("hub")} />
        ) : null}
      </div>
      <CrisisBar />
    </div>
...
/* ---------- hub / dashboard ---------- */
function Hub({ profile, plan, progress, saveProgress, journalCount, voiceOn, setVoiceOn, onOpenChat, onOpenJournal, onOpenToolkit, onOpenNotifications, onOpenCoordinator, onReset, isAdmin, authEnabled, onOpenAdmin, onOpenProfile, onSignOut, session }) {
  const { speak, stop, speaking } = useVoice(voiceOn);
