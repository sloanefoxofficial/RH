...
import {
  ...
  Shield, Eye, EyeOff, User, Megaphone, Youtube, ExternalLink, Radio, Paperclip, MessageCircle, Share2, Flame, HelpCircle,
} from "lucide-react";
...
- Merge with the existing notes; don't duplicate. Keep the total under 25 short items. Drop anything stale or superseded.
        ...
        <>
          {list.length === 0 && (
            <div style={{ color: T.sub, fontSize: 14, padding: "6px 2px 14px" }}>
              Nothing remembered yet. As you chat, a few notes will appear here.
            </div>
          )}
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 120, background: "rgba(44,42,51,0.45)",
          ...
          <div className="rh-in" style={{ width: "100%", maxWidth: 420, maxHeight: "84vh", overflowY: "auto",
            ...
            <div style={{ marginBottom: 12 }}>
              ...
              <p style={{ fontSize: 13.5, color: T.ink, lineHeight: 1.5, margin: 0 }}>You can edit or clear your profile any time, and "Start over" wipes your journey, journal, and saved conversations. Delete your account by asking Juan.</p>
            </div>
            <div style={{ marginBottom: 12 }}>
