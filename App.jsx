...
function Settings({ textScale, reduceMotion, bargeIn, responseSpeed, onSave, onBack }) {
  const sizes = [
...
function Hub({ profile, plan, progress, saveProgress, journalCount, voiceOn, setVoiceOn, onOpenChat, onOpenProgram, onOpenGuides, onOpenMerch, onOpenGames, onOpenToolkit, onOpenNotifications, onOpenCoordinator, onOpenSettings, onReset, isAdmin, authEnabled, onOpenAdmin, onOpenProfile, onSignOut, session, rexHistory, onSaveRexChat, memories, onConversation, answers, bargeIn, rexPersona }) {
  ...
  return (
    <>
      ...
      <div style={{ background: T.card, borderRadius: 20, overflow: "hidden", boxShadow: T.soft, marginTop: 10 }}>
        <img src="/mens_group.jpg" alt="Men's Group — Liverpool Area" style={{ width: "100%", display: "block" }} />
        <div style={{ padding: 16 }}>
          <div style={{ fontWeight: 800, fontSize: 16, marginBottom: 10 }}>💙 Men's Group — Liverpool Area</div>
          <p style={{ fontSize: 13.5, color: T.ink, lineHeight: 1.55, fontStyle: "italic", margin: "0 0 10px" }}>
          ...
          <p style={{ fontSize: 13.5, color: T.ink, lineHeight: 1.55, margin: "0 0 12px" }}>
          ...
          <div style={{ fontSize: 13, color: T.sub, lineHeight: 1.7, marginBottom: 12 }}>
          ...
          <p style={{ fontSize: 13.5, color: T.ink, lineHeight: 1.5, margin: "0 0 14px" }}>
            Come be seen. Come be known. You don't have to carry it alone.
          </p>
          <Btn onClick={onOpenCoordinator}>Message Juan to join</Btn>
        </div>
      </div>
