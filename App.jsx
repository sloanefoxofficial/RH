  ...
  return (
    <>
      ...
      <main style={{ marginTop: 8, paddingBottom: 30 }}>
        <section style={{ background: "linear-gradient(135deg, #f31812 0%, #ff3a2f 58%, #ff6250 100%)", border: "1px solid rgba(190,25,21,0.34)", borderRadius: 26, padding: 0, minHeight: 218, boxShadow: "0 16px 34px rgba(213,33,27,0.22)", position: "relative", overflow: "hidden" }}>
