...
import {
  ...
  Shield, Eye, EyeOff, User, Megaphone, Youtube, ExternalLink, Radio, Paperclip, MessageCircle, Share2,
} from "lucide-react";
    ...
    <div style={{ minHeight: "100vh", background: `linear-gradient(180deg, ${T.bgTop}, ${T.bgBot})`, color: T.ink,
      ...
      <div style={{ maxWidth: 460, margin: "0 auto", padding: "0 16px 132px", position: "relative" }}>
        {authEnabled && !authChecked ? (
          ...
          <Profile session={session} onReset={resetAll} onBack={() => go("hub")} />
...
function Profile({ session, onReset, onBack }) {
