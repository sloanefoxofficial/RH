...
export default function App() {
  ...
  const savePlan = useCallback((pl) => { if (pl && !pl.startedAt) pl.startedAt = Date.now(); setPlan(pl); sset("rh_plan", pl); }, []);
  ...
  return (
    <div style={{ background: T.card, borderRadius: 20, padding: 16, boxShadow: T.soft, marginBottom: 18 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 12 }}>
        <div style={{ width: 46, height: 46, borderRadius: "50%", background: "#fbe1e1", display: "grid", placeItems: "center", flexShrink: 0 }}>
