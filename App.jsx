      ...
      <main style={{ marginTop: 8, paddingBottom: 30 }}>
        <section style={{ background: "linear-gradient(118deg, #f31812 0%, #ff3a2f 42%, #fff8ef 100%)", border: "1px solid rgba(190,25,21,0.34)", borderRadius: 26, padding: 0, minHeight: 218, boxShadow: "0 16px 34px rgba(213,33,27,0.22)", position: "relative", overflow: "hidden" }}>
          ...
          <div style={{ minHeight: 218, display: "flex", alignItems: "stretch", position: "relative" }}>
            <div style={{ width: "42%", minWidth: 130, display: "flex", alignItems: "flex-end", justifyContent: "center", padding: "18px 0 0 7px" }}><img src="/partners/chaptly-character-transparent.png" alt="Chaptly character" style={{ width: "100%", maxWidth: 178, height: 205, objectFit: "contain", objectPosition: "center bottom", filter: "drop-shadow(0 11px 10px rgba(123,0,0,0.22))" }} /></div>
            <div style={{ flex: 1, display: "flex", flexDirection: "column", justifyContent: "center", padding: "18px 16px 18px 13px", margin: "12px 12px 12px 0", borderRadius: 20, background: "linear-gradient(145deg, rgba(96,6,5,0.82), rgba(137,14,11,0.9))", color: "#fff", boxShadow: "0 8px 20px rgba(112,8,6,0.14)" }}><h1 style={{ margin: "7px 0 8px", fontSize: 32, lineHeight: 1, letterSpacing: -0.6 }}>Chaptly</h1><p style={{ margin: 0, color: "rgba(255,255,255,0.95)", lineHeight: 1.48, fontSize: 13.5 }}>An AI-guided, trauma-informed recovery app for your next chapter.</p><a href="https://chaptly.app/" target="_blank" rel="noreferrer" style={{ alignSelf: "flex-start", display: "inline-flex", alignItems: "center", gap: 5, marginTop: 13, color: "#8f120f", background: "#fff8ed", borderRadius: 999, padding: "8px 11px", fontSize: 11, fontWeight: 900, textDecoration: "none" }}>Explore Chaptly <ExternalLink size={13} /></a></div>
          </div>
        </section>
