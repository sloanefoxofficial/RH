  ...
  return (
    <>
      ...
      <Chat char={CHARS.rex} profile={profile} answers={answers}
        ...
        voiceOn={voiceOn} setVoiceOn={setVoiceOn} onBack={() => {}} onOpenTool={() => {}} embedded bargeIn={bargeIn} />
...
/* ---------- chat ---------- */
function Chat({ char, profile, answers, history, setHistory, memories, onConversation, voiceOn, setVoiceOn, onBack, onOpenTool, embedded, bargeIn }) {
