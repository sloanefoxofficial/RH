...
export default function App() {
  ...
  goRef.current = go;
  const DEEP_LINK_SCREENS = ["notifications", "coordinator", "admin", "adminMessages"];
  useEffect(() => {
...
function Brand({ right }) {
  return (
    <header style={{ padding: "18px 2px 8px" }}>
      ...
      {right && (
        <div style={{ display: "flex", flexWrap: "wrap", justifyContent: "flex-end", alignItems: "center", gap: 6, marginTop: 12 }}>
          {right}
        </div>
      )}
    </header>
