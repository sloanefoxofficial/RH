    ...
    return (
      <>
        ...
        <div style={{ borderRadius: 18, overflow: "hidden", boxShadow: T.soft, background: "#07070c", border: `1px solid ${T.line}` }}>
          <iframe src={game.file} title={game.title} allow="fullscreen; autoplay"
        ...
        <p style={{ fontSize: 11.5, color: T.sub, textAlign: "center", marginTop: 10, lineHeight: 1.5 }}>
          Tip: tap "Full screen" for a bigger view. Just a bit of fun — no scores are saved.
        </p>
        <Disclaimer />
      </>
    );
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        {GAMES.map((g) => (
          <button key={g.id} onClick={() => setOpen(g.id)} style={{ width: "100%", textAlign: "left", cursor: "pointer",
            ...
            <div style={{ width: 52, height: 52, borderRadius: 14, background: "#1a1030", display: "grid", placeItems: "center", flexShrink: 0 }}>
              <Gamepad2 size={26} color="#8f7bd6" />
            </div>
            <div style={{ flex: 1, minWidth: 0 }}>
