      ...
      {open && (
        <div style={{ position: "fixed", inset: 0, zIndex: 120, background: "rgba(44,42,51,0.45)",
          ...
          <div className="rh-in" style={{ width: "100%", maxWidth: 420, maxHeight: "84vh", overflowY: "auto",
            ...
            {[
              ["What we keep", "Your account (email), anything you add to your profile (name, pronouns, bio, photo, private contact notes), your journal, your conversations with the guides, and any messages you send Juan."],
              ["Where it's kept", "Securely in our database. Your conversations with the guides are sent to a trusted AI service to generate replies. Voice, when on, is turned into speech by a voice service. We don't sell your information."],
              ["Who can see it", "Your private contact notes are visible only to you — not even an admin can read them. An admin can see your basic profile (name, email, bio) and the private messages you send Juan. Other members can never see your information."],
              ["Your control", "You can edit or clear your profile any time, and \u201CStart over\u201D wipes your journey, journal, and saved conversations. Delete your account by asking Juan."],
              ["Not for emergencies", "The Hub is a support tool, not a crisis or medical service. If you're in danger or need urgent help, use the crisis contacts shown at the top of the app."],
            ].map(([h, b]) => (
              <div key={h} style={{ marginBottom: 12 }}>
                <div style={{ fontWeight: 700, fontSize: 14, marginBottom: 3 }}>{h}</div>
                <p style={{ fontSize: 13.5, color: T.ink, lineHeight: 1.5, margin: 0 }}>{b}</p>
              </div>
            ))}
