  ...
  return (
    <>
      ...
      <main style={{ marginTop: 8, paddingBottom: 30 }}>
        <section style={{ background: "linear-gradient(118deg, #f31812 0%, #ff3a2f 42%, #fff8ef 100%)", border: "1px solid rgba(190,25,21,0.34)", borderRadius: 26, padding: 0, minHeight: 218, boxShadow: "0 16px 34px rgba(213,33,27,0.22)", position: "relative", overflow: "hidden" }}>
          <div style={{ position: "absolute", width: 260, height: 260, borderRadius: "50%", right: -125, top: -116, background: "rgba(255,255,255,0.12)" }} />
          <div style={{ position: "absolute", width: 170, height: 170, borderRadius: "50%", left: -92, bottom: -108, background: "rgba(117,0,0,0.13)" }} />
          <div style={{ minHeight: 218, display: "flex", alignItems: "stretch", position: "relative" }}>
            <div style={{ width: "42%", minWidth: 130, display: "flex", alignItems: "flex-end", justifyContent: "center", padding: "10px 7px 0", background: "linear-gradient(180deg, rgba(255,255,255,0.78), rgba(255,248,239,0.54))", borderRadius: "24px 0 0 24px", boxShadow: "inset -1px 0 rgba(255,255,255,0.46)" }}><img src="/partners/chaptly-character-transparent.png" alt="Chaptly character" style={{ width: "100%", maxWidth: 178, height: 213, objectFit: "contain", objectPosition: "center bottom", filter: "drop-shadow(0 11px 10px rgba(123,0,0,0.24))" }} /></div>
            <div style={{ flex: 1, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", textAlign: "center", padding: "18px 15px", margin: "12px 12px 12px 0", borderRadius: 20, background: "linear-gradient(145deg, rgba(96,6,5,0.84), rgba(137,14,11,0.92))", color: "#fff", boxShadow: "0 8px 20px rgba(112,8,6,0.14)" }}><h1 style={{ margin: "7px 0 8px", fontSize: 32, lineHeight: 1, letterSpacing: -0.6 }}>Chaptly</h1><p style={{ margin: 0, maxWidth: 190, color: "rgba(255,255,255,0.95)", lineHeight: 1.48, fontSize: 13.5 }}>An AI-guided, trauma-informed recovery app for your next chapter.</p><a href="https://chaptly.app/" target="_blank" rel="noreferrer" style={{ alignSelf: "center", display: "inline-flex", alignItems: "center", gap: 5, marginTop: 13, color: "#8f120f", background: "#fff8ed", borderRadius: 999, padding: "8px 11px", fontSize: 11, fontWeight: 900, textDecoration: "none" }}>Explore Chaptly <ExternalLink size={13} /></a></div>
          </div>
        </section>
        <section style={{ background: "#fffaf5", border: "1px solid rgba(243,24,18,0.18)", borderRadius: 22, padding: "20px 18px", marginTop: 14, boxShadow: T.soft }}>
        ...
        <section style={{ marginTop: 14 }}><h2 style={{ margin: "0 0 10px 3px", color: "#8f120f", fontSize: 21 }}>What you can explore</h2><div style={{ display: "grid", gap: 10 }}>{features.map(([title, text], i) => <article key={title} style={{ background: i % 2 ? "#fffaf5" : "#fff", border: "1px solid rgba(243,24,18,0.14)", borderRadius: 18, padding: "14px 15px", boxShadow: "0 5px 14px rgba(143,18,15,0.05)" }}><h3 style={{ margin: 0, color: "#c51d18", fontSize: 15 }}>{title}</h3><p style={{ margin: "6px 0 0", color: T.sub, lineHeight: 1.5, fontSize: 13 }}>{text}</p></article>)}</div></section>
        <section style={{ background: "linear-gradient(135deg, #fff3e8 0%, #fffaf5 58%, #fff 100%)", border: "1px solid rgba(243,24,18,0.17)", borderRadius: 22, padding: "18px", marginTop: 14 }}><h2 style={{ margin: 0, color: "#8f120f", fontSize: 20 }}>Ready to take a look?</h2><p style={{ margin: "8px 0 14px", color: T.sub, lineHeight: 1.5, fontSize: 14 }}>If Chaptly feels like it could support you, you can learn more or download it directly from your app store.</p><div style={{ display: "flex", flexWrap: "wrap", gap: 10 }}>{storeButton("https://apps.apple.com/us/app/chaptly/id6752330051", "App Store", <span style={{ fontSize: 25, lineHeight: 1 }}></span>, "#222")}{storeButton("https://play.google.com/store/apps/details?id=com.chaptly.app&pcampaignid=web_share", "Google Play", <Play size={22} fill="currentColor" />, "#3478c5")}</div><a href="https://chaptly.app/" target="_blank" rel="noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: 6, marginTop: 14, color: "#2e8578", fontWeight: 800, fontSize: 13 }}>Visit chaptly.app <ExternalLink size={15} /></a></section>
