        ...
        {visibleHistory.map((m, idx) => {
          ...
          return (
            <div key={idx} style={{ display: "flex", flexDirection: "column", alignItems: m.role === "user" ? "flex-end" : "flex-start" }}>
              ...
              <div
                onPointerDown={m.role === "assistant" ? (e) => { tapRef.current = { x: e.clientX, y: e.clientY, t: Date.now() }; } : undefined}
                onPointerUp={m.role === "assistant" ? (e) => {
                  ...
                  if (moved < 12 && Date.now() - s.t < 600) { if (!pauseResume()) speak(m.content, char, undefined, true); }
                } : undefined}
